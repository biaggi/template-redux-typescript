...
import { User, Repo, AccessToken } from "./githubTypes";
...
export const githubSlice = createSlice({
  ...
  reducers: {
    ...
    setFakeAccessToken: (state: GithubState): GithubState => {
      return {
        ...state,
        accessToken: {
          access_token: "test",
...
export const { logout, setFakeAccessToken } = githubSlice.actions;
